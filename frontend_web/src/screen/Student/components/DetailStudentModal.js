import { Avatar, Col, Descriptions, Image, Modal, Space, Spin, Table, Typography } from "antd";
...
export const DetailStudentModal = (
    ...
    return(
        ...
        >
            ...
            <Descriptions
                ...
                >
                    ...
                    label="Chức vụ"
                    >
                        <span style={{color:"red"}}>{selectedUser?.IsTeacher=="STUDENT"?"Học viên":"Giảng viên"}</span>
                    </Descriptions.Item>
                </Descriptions>
            </Col>
            </div>
       ...
       onClose={()=>{setVisibleCourse(false)}}
